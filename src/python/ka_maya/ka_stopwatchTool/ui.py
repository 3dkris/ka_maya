...
class StopwatchUIWindow(QtGui.QMainWindow):
    """
    ...
    def __init__(self, **kwargs):
        ...
        runTimerAction = QtGui.QAction('New - Stopwatch Recording', self)
        ...
        openAction = QtGui.QAction('Open - Stopwatch Recording', self)
        ...
        # New tab Action
        newTimerInfoTabAction = QtGui.QAction('Add Tab - Timer Info ', self)
    ...
    def openStopwatchRecording(self):
        ...
        try:
            filePath = QtGui.QFileDialog.getOpenFileName(self, 'Open file', defaultSaveDirectory)

        except:
            filePath = QtGui.QFileDialog.getOpenFileName(self, 'Open file', DEFAULT_SAVE_DIRECTORY)
...
class NewStopwatchRecordingWindow(QtGui.QMainWindow):
    """
    ...
    def __init__(self, stopwatchWindow=None, **kwargs):
        ...
        self.hLayoutA = QtGui.QHBoxLayout()
        ...
        self.frameRangeStartField = QtGui.QSpinBox()
        self.frameRangeEndField = QtGui.QSpinBox()
        frameRangeLayout = QtGui.QHBoxLayout()
        ...
        # buttons
        button = QtGui.QPushButton('Start / Save')
    ...
    def startRecording(self):
        ...
        try:
            rootDir = QtGui.QFileDialog.getSaveFileName(self, 'Save file', defaultSaveDirectory)

        except:
            rootDir = QtGui.QFileDialog.getSaveFileName(self, 'Save file', DEFAULT_SAVE_DIRECTORY)
...
class StopwatchDataWidget(QtGui.QWidget):
    def __init__(self, **kwargs):
...
class StopwatchDataWidget_times(QtGui.QWidget):
    ...
    def __init__(self, **kwargs):
        ...
        # list View
        self.timesTabelView = QtGui.QTableView()
        ...
        self.timesTabelView.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
        ...
        self.displayRedundantComputesAction = QtGui.QAction('Display Redundant Computes', self)
        self.displayPercentsAction = QtGui.QAction('Display Percents', self)
        self.displayCountAction = QtGui.QAction('Display Count', self)
        self.displayTimeAction = QtGui.QAction('Display Time', self)
        self.displayNodeTypeAction = QtGui.QAction('Display NodeType', self)
        self.displayNodeNameAction = QtGui.QAction('Display Node Name', self)
        ...
        # Find Node Action
        findNodeAction = QtGui.QAction('Find Node', self)
        ...
        if selection:
            ...
            if selection not in dataModel.data_nodeNames:
                ...
                for i in range(5):
                    ...
                    selectionModel.setCurrentIndex(qIndex, QtGui.QItemSelectionModel.Select)
...
class StopwatchDataWidget_traces(QtGui.QWidget):
    ...
    def __init__(self, **kwargs):
        ...
        self.layout = QtGui.QSplitter(QtCore.Qt.Vertical)
        layout.addWidget(self.layout)

        # create metric top List Splitter
        metricSplitter = QtGui.QSplitter(QtCore.Qt.Horizontal)
        self.layout.addWidget(metricSplitter)

        # create metric vertical (1 item) splitter 0
        metricSplitter0 = QtGui.QSplitter(QtCore.Qt.Vertical)
        metricSplitter.addWidget(metricSplitter0)

        # create metric vertical (5 item) splitter 1
        metricSplitter1 = QtGui.QSplitter(QtCore.Qt.Vertical)
        metricSplitter.addWidget(metricSplitter1)

        # all metric list
        self.allList = QtGui.QTreeView()
        self.allList.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)

        self.allListData = QtGui.QStandardItemModel()
        ...
        # compute metric list
        self.computeList = QtGui.QTreeView()
        self.computeList.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)
        self.computeList.clicked.connect(self.metricListItemSelected)

        self.computeListData = QtGui.QStandardItemModel()
        ...
        # dirty metric list
        self.dirtyList = QtGui.QTreeView()
        self.dirtyList.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)

        self.dirtyListData = QtGui.QStandardItemModel()
        ...
        # fetch metric list
        self.fetchList = QtGui.QTreeView()
        self.fetchList.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)

        self.fetchListData = QtGui.QStandardItemModel()
        ...
        # draw metric list
        self.drawList = QtGui.QTreeView()
        self.drawList.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)

        self.drawListData = QtGui.QStandardItemModel()
        ...
        # draw callback list
        self.callbackList = QtGui.QTreeView()
        self.callbackList.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)

        self.callbackListData = QtGui.QStandardItemModel()
        ...
        for metricView in (self.computeList,
            ...
            for qIndex in selectedIndices:
                ...
                if allList_itemIndex not in allList_selectedIndices:
                    metricView.selectionModel().setCurrentIndex(qIndex, QtGui.QItemSelectionModel.Deselect)
    ...
    def _metricListSelectionChanged_otherMetrics_(self, *args):
        ...
        for metricView in (self.computeList,
            ...
            for qIndex in selectedIndices:
                ...
                if allList_itemIndex not in allList_selectedIndices:
                    self.allListSelectionModel.setCurrentIndex(allList_itemIndex, QtGui.QItemSelectionModel.Select)
        ...
        for qIndex in deselectList:
            if qIndex not in selectedList:
                self.allListSelectionModel.setCurrentIndex(qIndex, QtGui.QItemSelectionModel.Deselect)
    ...
    def metricListItemSelected(self):
        ...
        #if isinstance(qItemSelection, QtGui.QItemSelection):
